...
func query(word string) {
	client := &http.Client{}
	//var data = strings.NewReader(`{"trans_type":"en2zh","source":"target"}`)
	input := DictRequest{TransType: "en2zh", Source: word}
	...
	req.Header.Set("device-id", "b22e4f2319efd727bb9bc413a05065b9")
...
func main() {
	if len(os.Args) != 2 {
		fmt.Fprintf(os.Stderr, "usage: xxx WORD")
		os.Exit(1)
	}
	word := os.Args[1]
	query(word)
